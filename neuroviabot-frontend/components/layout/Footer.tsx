...
export default function Footer() {
  ...
  const footerLinks = {
    product: [
      ...
      { name: 'Sunucularım', href: '/servers' },
      { name: 'Pazar Yeri', href: '/marketplace' },
    ],
    company: [
      { name: 'Hakkımızda', href: '/about' },
      { name: 'İletişim', href: '/iletisim' },
      { name: 'Geri Bildirim', href: '/geri-bildirim' },
    ],
    legal: [
  ...
  const socialLinks = [
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/neuroviabot',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/neuroviabot',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="relative bg-gray-900/50 backdrop-blur-xl border-t border-white/10 mt-20">
      <div className="container mx-auto px-4 py-12 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Discord sunucunuz için gelişmiş yönetim, eğlence ve ekonomi sistemi.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            © {currentYear} NeuroViaBot. Tüm hakları saklıdır.
          </p>
