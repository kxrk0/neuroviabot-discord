          ...
          <div className="max-w-7xl mx-auto px-6 py-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                >
                  Sunucularını yönet ve özelleştir
                </motion.p>
              </div>
...
function StatsCard({ icon, label, value, gradient }: StatsCardProps) {
  return (
    ...
    >
      ...
      <motion.div 
        className={`absolute -inset-0.5 bg-gradient-to-r ${gradient} rounded-2xl opacity-0 group-hover:opacity-100 blur-md transition-all duration-500`}
        animate={{
      ...
      {/* Glow effect */}
      <div className={`absolute inset-0 bg-gradient-to-r ${gradient} opacity-0 group-hover:opacity-5 rounded-2xl blur-2xl transition-all duration-500`}></div>
      
      <div className="relative p-6 bg-gradient-to-br from-gray-900/95 to-gray-900/80 backdrop-blur-2xl border-2 border-white/10 group-hover:border-purple-500/30 rounded-2xl shadow-xl group-hover:shadow-2xl group-hover:shadow-purple-500/20 transition-all duration-500">
        <motion.div 
          className={`inline-flex items-center justify-center w-12 h-12 mb-3 rounded-xl bg-gradient-to-br ${gradient} text-white`}
        ...
        <motion.div
          className="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-purple-500 to-blue-500 rounded-b-2xl"
          initial={{ width: 0 }}
          animate={{ width: '100%' }}
